...
#SBATCH --array=0-32   # Replace <N-1> with the number of files minus one

# Define paths
WORK_DIR=/home/stan0477/meye2099/Algae_Evolution/Trebouxiophyceae/PAML/codeml
ALIGN_DIR=/home/stan0477/meye2099/Algae_Evolution/Trebouxiophyceae/CDS/filtered_alignments
TREE_DIR=/home/stan0477/meye2099/Algae_Evolution/Trebouxiophyceae/PAML/codeml/Gene_Trees
OUT_DIR=/home/stan0477/meye2099/Algae_Evolution/Trebouxiophyceae/PAML/codeml/output
...
OUTPUT_FILE=Trebouxiophyceae_${GENE_NAME}_M0.out
CTL_FILE=$WORK_DIR/codeml_${GENE_NAME}_M0.ctl

# Create a unique codeml control file for the current gene
cat > $CTL_FILE << EOL
      seqfile = $SEQ_FILE   * sequence data file name
      treefile = $TREE_FILE  * tree structure file name
      outfile = $OUT_DIR/$OUTPUT_FILE * main result file name
