#!/bin/bash
#SBATCH --job-name=codeml_job_pooled_M2
...
# Grab tree files
TREE_FILE=${TREE_DIR}/${GENE_NAME}_aligned_M2.txt

# Define the output file name and unique control file name for each array job
OUTPUT_FILE=Trebouxiophyceae_${GENE_NAME}_M2.out
CTL_FILE=${PAML_DIR}/Tre_${GENE_NAME}_M2
